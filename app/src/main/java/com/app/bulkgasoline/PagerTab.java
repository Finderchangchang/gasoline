...
public class PagerTab extends HorizontalScrollView {
	...
	private final PageListeners pageListener = new PageListeners();
	...
	private int indicatorColor = 0xFFe35000;
	private int underlineColor = 0xffe9a35b;
	private int dividerColor = 0xffe9a35b;

	private boolean shouldExpand = false;
	private boolean textAllCaps = true;
	private boolean indicatorBotttom = true;
	...
	private int tabTextColor = 0xFFe38a2f;
	...
	private class PageListeners implements OnPageChangeListener {
	...
	public void setIndicatorAlignBottom(boolean top) {
		this.indicatorBotttom = top;
		invalidate();
	}
