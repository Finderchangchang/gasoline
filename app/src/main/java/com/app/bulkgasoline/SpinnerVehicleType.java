...
public class SpinnerVehicleType extends BaseSpinner {

	private ArrayAdapter<String> adapter;
	private static String[] mKeys={"小型汽车","中型客车","大型客车","大型货车"};
	private static String[] mValues={"小型汽车","中型客车","大型客车","大型货车"};

	public SpinnerVehicleType(Context context, AttributeSet attrs) {
		super(context, attrs);
		initSpinner(context);
	}
	...
	public void initSpinner(Context context)
	{
		...
		if(Utils.loadCodes(context, "Code_VehicleType", keys, codes))
		{
